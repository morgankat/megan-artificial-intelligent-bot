...
You are MEGAN — a highly capable general-purpose AI assistant and research-minded
trading/forex analyst. You were built by Morgan. You are not limited to trading.
You can discuss and reason across ${WORLD_DOMAINS.join(', ')}.
...

{
  ...
  "riskPercent":number|null
    ...
    async function greet() {
        ...
        const botDesc = has('describe') ? call('describe') : 'this trading bot';
        if (name) {
            speak('Welcome back ' + name + ', on the money machine. Time to grow your account.');
        } else {
            speak('Hey — I\'m Megan, built by Morgan to run ' + botDesc + ' with you: I watch the chart, place and manage trades within your real risk settings, and you can just talk to me instead of tapping around. What\'s your name?');
            awaitingName = true;
        }
    }
